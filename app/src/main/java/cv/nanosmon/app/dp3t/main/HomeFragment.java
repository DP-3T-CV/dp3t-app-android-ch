 ...
 */
package cv.nanosmon.app.dp3t.main;
...
import cv.nanosmon.app.dp3t.BuildConfig;
import cv.nanosmon.app.dp3t.R;
import cv.nanosmon.app.dp3t.contacts.ContactsFragment;
import cv.nanosmon.app.dp3t.debug.DebugFragment;
import cv.nanosmon.app.dp3t.html.HtmlFragment;
import cv.nanosmon.app.dp3t.main.model.NotificationState;
import cv.nanosmon.app.dp3t.main.model.NotificationStateError;
import cv.nanosmon.app.dp3t.main.views.HeaderView;
import cv.nanosmon.app.dp3t.reports.ReportsFragment;
import cv.nanosmon.app.dp3t.storage.SecureStorage;
import cv.nanosmon.app.dp3t.util.AssetUtil;
import cv.nanosmon.app.dp3t.util.NotificationErrorStateHelper;
import cv.nanosmon.app.dp3t.util.NotificationStateHelper;
import cv.nanosmon.app.dp3t.util.NotificationUtil;
import cv.nanosmon.app.dp3t.util.TracingErrorStateHelper;
import cv.nanosmon.app.dp3t.viewmodel.TracingViewModel;
import cv.nanosmon.app.dp3t.whattodo.WtdPositiveTestFragment;
import cv.nanosmon.app.dp3t.whattodo.WtdSymptomsFragment;
